...
def get_parameters(net) -> List[np.ndarray]:
    ...
    return [
        ...
        else np.zeros_like(p.data.cpu().numpy())
...
class FedSparse(FedAvg):
    ...
    def set_gradients(self, net, gradients: List[np.ndarray]):
    ...
    def aggregate_fit(
        ...
        # gradients_aggregated = aggregate(gradients_results)
        # Set gradients
        # self.set_gradients()
        # udpate server model

        # get parameters from server model
